...
Write-Host "========================================"
Write-Host "DRUMMOND CLOUD FACTORY 02 FULL 05"
Write-Host "LONG_ONLY"
Write-Host "========================================"
Write-Host ("DATASET_ID=" + $datasetId)
Write-Host ("TAG=" + $datasetTag)
Write-Host ""
Write-Host "Triggering full LONG_ONLY lifecycle workflow..."
...
if ($LASTEXITCODE -ne 0) { throw "Failed to list Factory 05 runs" }

Write-Host ""
Write-Host "CLOUD FACTORY 02 FULL 05 LONG_ONLY TRIGGER PASS"
