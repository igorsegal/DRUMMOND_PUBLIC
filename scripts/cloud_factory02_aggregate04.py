...
def main():
    ...
    write_csv(a.out/"FACTORY04_SYMBOLS.csv",final)

    summary={
        "block":"CLOUD FACTORY 02 FULL 04 AGGREGATE",
    ...
    (a.out/"FACTORY04_SUMMARY.json").write_text(
        json.dumps(summary,ensure_ascii=False,indent=2)+"\n",encoding="utf-8"
    )
    lines=[
        "CLOUD FACTORY 02 FULL 04 AGGREGATE",
    ...
    (a.out/"FACTORY04_SUMMARY.txt").write_text("\n".join(lines)+"\n",encoding="utf-8")
    print("\n".join(lines))
